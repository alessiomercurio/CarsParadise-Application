...
public class Utils {
    ...
    public static void creaInterfacciaLogin(Stage primaryStage) throws IOException {
        stage = primaryStage;
        Parent root = FXMLLoader.load(Main.class.getResource("GestioneAccount/Login.fxml"));
        Scene scene = new Scene(root, 700, 600);
        primaryStage.setTitle("Autenticazione");
